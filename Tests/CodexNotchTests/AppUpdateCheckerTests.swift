...
final class AppUpdateCheckerTests: XCTestCase {
    func testDefaultEndpointIsThisFork() {
        XCTAssertEqual(
            AppUpdateChecker.defaultEndpoint.absoluteString,
            "https://api.github.com/repos/Jayzengcodetrip/codex-reset-reminder-mac/releases/latest"
        )
    }
    ...
    func testNewerStableReleaseIsReportedWithoutAuthorizationHeader() async throws {
        ...
        XCTAssertEqual(release.url.absoluteString, "https://github.com/Jayzengcodetrip/codex-reset-reminder-mac/releases/tag/v0.1.12")
    }
    ...
    private func makeChecker() throws -> AppUpdateChecker {
        ...
        return AppUpdateChecker(
            ...
            endpoint: URL(string: "https://api.example.test/repos/Jayzengcodetrip/codex-reset-reminder-mac/releases/latest")!
        )
    }
    ...
    private func releaseData(
        ...
        let json: [String: Any] = [
            "tag_name": tag,
            "html_url": htmlURL ?? "https://github.com/Jayzengcodetrip/codex-reset-reminder-mac/releases/tag/\(tag)",
            "draft": draft,
    ...
    private func response(status: Int) -> HTTPURLResponse {
        HTTPURLResponse(
            url: URL(string: "https://api.example.test/repos/Jayzengcodetrip/codex-reset-reminder-mac/releases/latest")!,
            statusCode: status,
            httpVersion: nil,
