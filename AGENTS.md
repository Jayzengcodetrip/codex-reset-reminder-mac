...
- Keep every independently pending announcement and its own published-time countdown. Read/unread state or elapsed target time alone must not remove one; use explicit source completion or cancellation. Do not assign ordinal numbers to announcements.
